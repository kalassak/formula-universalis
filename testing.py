...
def run_lap(track, qualifying, car, driver, car_ahead_time, driver_ahead_def, car_behind_time, lap, rainstat_flag, was_raining, was_wet):
	...
	cornering = math.sqrt(1/(car.t/track.c)**(power1*2) + 1/(driver.c/track.c)**(power2*2))
	...
	if car.tiretype == "DRY":
		...
		weather = ((95/90-1)*track.l*(1-current_wetness)*2+1)*math.exp(-driver.a/10)
...
track1 = Track(1.0, 1.0, 1.0, 0, 30.0)
...
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Solea Racing")) #27
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Solea Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Solea Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Dotruga Formula Racing")) #26
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Dotruga Formula Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Dotruga Formula Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Cows Go Moo Racing")) #23
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Cows Go Moo Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Cows Go Moo Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "BONGATAR")) #
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "BONGATAR"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "BONGATAR"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team V.V. Imperial")) #25
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team V.V. Imperial"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team V.V. Imperial"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Diigikwk Racers")) #26
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Diigikwk Racers"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Diigikwk Racers"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Vincent")) #16
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Vincent"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Vincent"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Blaland Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Blaland Racing"))
cars.append(Car(5.0, 5.0, 5.0, 5.0, 1.0, 100.0, "DRY", 0.0, 999.0, 0, "Team Blaland Racing"))
#					  CRN  OVTK DEF  FINE TECH ADPT
drivers.append(Driver(10.0, 5.0, 1.0, 5.0, 5.0, 3.0, 9, 47, u"ketila léqa pavúteka")) #17
drivers.append(Driver(5.0, 3.0, 4.0, 5.0, 5.0, 2.0, 7, 19, u"khélok atep zailunaɰ")) #17
drivers.append(Driver(1.0, 2.0, 3.0, 5.0, 5.0, 1.0, 1, 31, u"xap'ít celentir šaŋév")) #17
drivers.append(Driver(10.0, 5.0, 1.0, 5.0, 5.0, 3.0, 9, 47, u"ketila léqa pavúteka")) #17
drivers.append(Driver(5.0, 3.0, 4.0, 5.0, 5.0, 2.0, 7, 19, u"khélok atep zailunaɰ")) #17
drivers.append(Driver(1.0, 2.0, 3.0, 5.0, 5.0, 1.0, 1, 31, u"xap'ít celentir šaŋév")) #17
drivers.append(Driver(10.0, 5.0, 1.0, 5.0, 5.0, 3.0, 9, 47, u"ketila léqa pavúteka")) #17
...
drivers.append(Driver(5.0, 3.0, 4.0, 5.0, 5.0, 2.0, 7, 19, u"khélok atep zailunaɰ")) #17
drivers.append(Driver(1.0, 2.0, 3.0, 5.0, 5.0, 1.0, 1, 31, u"xap'ít celentir šaŋév")) #17
#1 2 3 4 5 11 14 19 20 21 22 26 29 30 31 35 41 42 44 47 53 69 74 80 81 82 94 98 - what were swonx's people tbh
